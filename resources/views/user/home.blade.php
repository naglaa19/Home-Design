...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="continer_5">
          ...
          <div class="first_collaction_one" >
            <div class="img_back_1">
              <img src="images/icon1_1.png" width="82%">
            </div>
        ...
        <div class="third_collection">
           ...
           <img src="{{asset("images/home/4f8443799591c97b327faa7f13eb1df9.jpg")}}">
           <img src="{{asset("images/home/5da519561e7201f442c2238e0d33537c.jpg")}}">
           <img src="{{asset("images/home/15f03689b6833ed599fed68c51c0f562.jpg")}}">
           <img src="{{asset("images/home/30ac113c4bbaff6283c92a557211a5d4.jpg")}}">
           </div>
           <div class="image_slider">
            <img src="{{asset("images/home/79e991524a2a5d15180c30441299ad8f.jpg")}}">
            <img src="{{asset("images/home/878ccb9e6c6d1eb7d5bb92efc210ad63.jpg")}}">
            <img src="{{asset("images/home/354720e7960c899078c3bebef2c808b4.jpg")}}">
            <img src="{{asset("images/home/8353130280b5c65696caa4d74ea10b6e.jpg")}}">
           </div>
           <div class="image_slider">
            <img src="{{asset("images/home/feee2ec861fbf492f72cdbd3233e863d.jpg")}}">
            <img src="{{asset("images/home/ffbcb67948def2e346d3d92ab4c64853.jpg")}}">
            <img src="{{asset("images/home/a01d1ef16e697ed1b6dd29d59d568208.jpg")}}">
            <img src="{{asset("images/home/914a2324b832138e8d021c9a5495011d.jpg")}}">
           </div>
           <div class="image_slider">
            <img src="{{asset("images/home/timerSlider/100cf4ce4f9d605343abe45fea053434.jpg")}}">
            <img src="{{asset("images/home/timerSlider/296a26275905a00675cbb277d5d626ea.jpg")}}">
            <img src="{{asset("images/home/timerSlider/670f3f9c80608fc75c5f7e720a7bdeca.jpg")}}">
            <img src="{{asset("images/home/timerSlider/662589d12342f47205744c7738bbf0e6.jpg")}}">
           </div>
        ...
        <div class="continer_5_slider">
          ...
          <div class="slideshow-container">
            ...
            <div class="mySlides fade">
              ...
              <img src="{{asset("images/home/slider/1.jpg")}} style="width:100%">
              <div class="text">Caption Text</div>
            </div>
            
            <div class="mySlides fade">
              <div class="numbertext">2 / 9</div>
              <img src="{{asset("images/home/slider/2.jpeg")}} style="width:100%">
              <div class="text">Caption Two</div>
            </div>
            
            <div class="mySlides fade">
              <div class="numbertext">3 / 9</div>
              <img src="{{asset("images/home/slider/3.jpg")}} style="width:100%">
              <div class="text">Caption Three</div>
            </div>
            <div class="mySlides fade">
              <div class="numbertext">4 / 9</div>
              <img src="{{asset("images/home/slider/4.jpg")}}" style="width:100%">
              <div class="text">Caption Three</div>
            </div>
            <div class="mySlides fade">
              <div class="numbertext">5 / 9</div>
              <img src="{{asset("images/home/slider/5.jpeg")}}" style="width:100%">
              <div class="text">Caption Three</div>
            </div>
            <div class="mySlides fade">
              <div class="numbertext">6 / 9</div>
              <img src="{{asset("images/home/slider/6.jpg")}}" style="width:100%">
              <div class="text">Caption Three</div>
            </div>
            <div class="mySlides fade">
              <div class="numbertext">7 / 9</div>
              <img src="{{asset("images/home/slider/7.jpg")}}" style="width:100%">
              <div class="text">Caption Three</div>
            </div>
            <div class="mySlides fade">
              <div class="numbertext">8 / 9</div>
              <img src="{{asset("images/home/slider/8.png")}}" style="width:100%">
              <div class="text">Caption Three</div>
            </div>
            <div class="mySlides fade">
              <div class="numbertext">9 / 9</div>
              <img src="{{asset("images/home/slider/9.jpg")}}" style="width:100%">
              <div class="text">Caption Three</div>
            </div>
        ...
        <div class="contnier_6">
          ...
          <div class="rightside_contnier_6"> 
           ...
           <p class="see_more">See How Using LA CASA APP</p>
